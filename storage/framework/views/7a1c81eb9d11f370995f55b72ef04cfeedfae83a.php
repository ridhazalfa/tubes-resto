			...
			<div class="row">
				...
				<div class="col-6 col-md-4" style='margin-left:100px'>
					...
					<div style="max-height:400px;overflow:auto;">
						...
						<div class="daftar menu" id="row<?php echo e($menu->id); ?>">
							<img src="<?php echo e(asset('Image_Menu/'.$menu->gambar)); ?>" alt="Foto Menu" style="float:left;width:86px;height:86px;margin-right:5px;" >
							<a style="text-decoration:none;color:black;" href="/menu/<?php echo e($menu->id); ?>/edit"><?php echo e($menu->nama); ?></a>
							<p name="deskripsi"><?php echo e($menu->deskripsi); ?></p>
							<span name="harga">Rp <?php echo e($menu->harga); ?></span>
						</div>
...
<?php /**PATH D:\#ARTISA BUNGA SYAHPUTRI#\Aplikasi\TUBES-app\resources\views/Registrasi2-2.blade.php ENDPATH**/ ?>