  ...
  <main>
    ...
    <div class="container m-4">
      <ul class="nav nav-tabs justify-content-center nav-fill" id="myTab">
        ...
        <li class="nav-item">
          <a href="#masuk" class="nav-link" data-bs-toggle="tab">Transaksi Masuk</a>
        </li>
        <!--Tab 2: Transaksi Berlangsung -->
        <li class="nav-item">
          <a href="#berlangsung" class="nav-link" data-bs-toggle="tab">Transaksi Berlangsung</a>
        </li>
        <!--Tab 3 : Riwayat Transaksi -->
        <li class="nav-item">
          <a href="#riwayat" class="nav-link" data-bs-toggle="tab">Riwayat</a>
        </li>
      </ul>
      <div class="tab-content">
        <!--Content Tab 1: Transaksi Masuk -->
        <div class="tab-pane fade" id="masuk">
          <h4 class="m-4 text-semi">Transaksi Masuk</h4>
          <div class="card-content">
            <div class="card p-4 m-2">
              <p class="text-xs text-semi mb-1">IDORDER : 1234521234</p>
              <p class="text-2xs mb-3" style="color: #727472">waktu, tanggal masuk</p>
              <p class="text-2xs mb-1">idResto <span><svg class="bi bi-arrow-left-right mx-2" width="16" height="16"><use xlink:href="#Transaksi"/></svg></span> idCustomer</p>
              <p class="text-2xs mb-1" style="color: #727472">Tanggal Reservasi : </p>
              <p class="text-2xs mb-1" style="color: #727472">Waktu Reservasi : </p>
              <span><button class="btn btn-primary float-right ml-2">Konfirmasi</button>
              <button class="btn btn-outline-danger float-right">Batal</button></span>
            </div>
          </div>
        </div>
        <!--Content Tab 2: Transaksi Berlangsung-->
        <div class="tab-pane fade" id="berlangsung">
          <h4 class="m-4 text-semi">Transaksi Masuk</h4>
          <div class="card-content">
            <div class="card p-4 m-2">
              <p class="text-xs text-semi mb-1">IDORDER : 1234521234</p>
...
</html><?php /**PATH D:\#ARTISA BUNGA SYAHPUTRI#\Aplikasi\TUBES-app\resources\views/Transaksi.blade.php ENDPATH**/ ?>