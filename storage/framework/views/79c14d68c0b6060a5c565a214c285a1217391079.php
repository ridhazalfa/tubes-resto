    ...
    <main>
      <div class="row g-5">
        <div class="col-md-5 col-lg-4 order-md-last">
          ...
          <?php $__currentLoopData = $simpan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <ul class="list-group mb-3">
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div>
                <h6 class="my-0"><?php echo e($s->lokasi_meja); ?></h6>
                <small class="text-muted"><?php echo e($s->jenis_meja); ?></small>
              </div>
              <span class="text-muted"><?php echo e($s->jumlah_meja); ?></span>
                
            </li>
            <a href="/hapus/<?php echo e($s->id); ?>" onclick="return confirm('Apakah anda ingin menghapus meja?');" class="btn btn-danger btn-md">hapus</a>  
          </ul>
        ...
        <div class="col-md-7 col-lg-8">
          ...
          <form method="POST" action="<?php echo e(route('simpan')); ?>" enctype="multipart/form-data">
            ...
            <button class="w-25 btn btn-success btn-sm" ><a href="<?php echo e(URL::to('/dasboar1')); ?>" style="color:white;text-decoration: none">Simpan dan selesai</a></button>
...
<?php /**PATH D:\#ARTISA BUNGA SYAHPUTRI#\Aplikasi\TUBES-app\resources\views/Registrasi3-2.blade.php ENDPATH**/ ?>