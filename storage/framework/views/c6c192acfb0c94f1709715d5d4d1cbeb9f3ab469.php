      ...
      <div class="row g-5" >
        <div class="col-md-5 col-lg-4 order-md-last" style="max-height: 700px; overflow: auto;">
          ...
          <ul class="list-group mb-3">
            ...
            <a href="/hapusMeja/<?php echo e($s->id); ?>" onclick="return confirm('Apakah anda ingin menghapus meja?');" class="btn btn-danger btn-md">hapus</a>  
          </ul>
...
</html><?php /**PATH D:\#ARTISA BUNGA SYAHPUTRI#\Aplikasi\TUBES-app\resources\views/DasboardMeja.blade.php ENDPATH**/ ?>