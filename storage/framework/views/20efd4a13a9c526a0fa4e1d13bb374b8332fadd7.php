			...
			<form method="POST" action="/delMenu">
				...
				<div style="max-height:400px;overflow:auto;">
					...
					<div class="card border-light">
						<div>
							<input type="checkbox" id="<?php echo e($menu->id); ?>" name="menuid[]" value="<?php echo e($menu->id); ?>" style="float:left;margin-top:65px;margin-bottom:45px;margin-right:25px;"/>
							<br>
...
</html><?php /**PATH D:\#ARTISA BUNGA SYAHPUTRI#\Aplikasi\TUBES-app\resources\views/DasboardMenu-hapus.blade.php ENDPATH**/ ?>