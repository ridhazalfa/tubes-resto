		...
		<div class="col-md-4" style='margin-left:50px;padding:20px;'>
			...
			<div class="d-flex justify-content-between align-items-center mb-3">
				...
				<form action="/halamanDel">
					<button class="btn btn-outline-secondary" style="float:right;">Hapus</button>
				</form>
			</div>
				<div style="max-height:450px;overflow:auto;">
					...
					<div class="card border-light">
						<div>
							<br>
							<img src="<?php echo e(asset('Image_Menu/'.$menu->gambar)); ?>" alt="Foto Menu" style="float:left;width:100px;height:100px;margin-right:5px;" >
							<a style="text-decoration:none;color:black;" href="/menu/<?php echo e($menu->id); ?>/update"><?php echo e($menu->nama); ?></a>
...
</html><?php /**PATH D:\#ARTISA BUNGA SYAHPUTRI#\Aplikasi\TUBES-app\resources\views/DasboardMenu.blade.php ENDPATH**/ ?>